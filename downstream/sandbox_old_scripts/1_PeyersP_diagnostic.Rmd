...
base_dir <- "PeyersP_8OUTS"

# Define output directories
rds_dir  <- file.path(base_dir, "PeyersP_rds")
fig_dir  <- file.path(base_dir, "PeyersP_figs")
...
This is a dignostic to see if the HT5 KO works.
...
seu <- merge(
  ...
  project = "PeyersP_8_samples",merge.data = TRUE
)
```
...
```
COUPOE-PP-POS1             COUPOE-PP1             COUPOE-PP2              COUPWT-PP  PP-COUPKO-HT6-cre-neg 
                  1343                   4895                   5800                   6233                    486 
 PP-COUPKO-HT7-cre-pos PP2-RBPJKO-HT5-cre-pos PP2-RBPJKO-HT6-cre-neg 
                   278                   2310                   1298 
```{r}
...
saveRDS(
  object = seu,
  file = file.path(rds_dir, "pp_int_join_layers.rds")) # just in case
#   
#   
# # Load it back
