...
```{r, fig.width=9, fig.height=7}
# Genes you care about
goi <- c("Madcam1", "St6gal1","Nr2f2" ,"Nkx2-3", "Ccl21a","Ccl21","Ubd", "Fut7", "Oit1", "Clu" ,"Vwf" ,"Selp", "Vcam1", "Glycam1", "Icam1")
         #addressin                                                   
...
save_pub(plot=p,filename= "oe_wt_reprog_goi_EVplot", width = 9,height=7)
```
...
pathview(
  gene.data  = ranks_entrez,# will create this below
  pathway.id = "mmu04510",     # your enriched KEGG pathway
  species    = "mmu",
  out.suffix =  "OE_vs_KO"
)
setwd(old)
