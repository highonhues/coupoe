...
celltype_dir <- file.path(base_dir, "PP_CapEC2")
...
##DGE
```{r}
pb_pcv <- pseudobulk_celltype(seu, celltype = "CapEC2")
...
p <- EnhancedVolcano(
  ...
  widthConnectors = 0.5,
  colConnectors = 'black',
  title = 'OE vs WT - Adhesion Molecules CapEC2'
)
...
for (pid in kegg_ids) {
  ...
  pathview(
    ...
    pathway.id = pid,
    species    = "mmu",
    out.suffix = paste0("OE_vs_WT_capec2", pid)
  )
}
...
p <- EnhancedVolcano(
  ...
  widthConnectors = 0.5,
  colConnectors = 'black',
  title = 'KO vs WT - Adhesion Molecules CapEC2'
)
