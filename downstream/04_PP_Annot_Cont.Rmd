...
Seurat::DimPlot(seu_obj, group.by = c("RNA_snn_res.0.3","RNA_snn_res.0.4", "RNA_snn_res.0.6"),label=TRUE, ncol=1)
```


```{r}
Idents(seu_obj) <- "RNA_snn_res.0.6"
```
...
write.csv(markers_all_bec,
          file = "PP_outputs/markers_all_bec_Reann.csv",
          row.names = FALSE)
...
write.csv(conserved_markers,
          file = "PP_outputs/conserved_markers_bec.csv",
          row.names = FALSE)
