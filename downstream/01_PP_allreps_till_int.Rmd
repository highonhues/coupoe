...
Well cell cycle remova; just wont work here so i guess you gotta do this post cell subset? No post int joining


DimPlot reduction: Which dimensionality reduction to use. If not specified, first searches for umap, then tsne, then pca
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
FastMNN records its own pca dn not teh one thats being passed and hence is more resistant to batch eff and cell cycle ig so actually really truly dgaf to me i guess
```{r}
...
Fisr calculate score



```{r}
#seu <- FindNeighbors(seu, reduction = "integrated.mnn", dims = 1:35)
seu <- FindNeighbors(seu, reduction = "mnn.reconstructed", dims = 1:35) #or set default as that diabolical
...
seu <- RunUMAP(seu,  dims = 1:35, reduction.name = "umap.mnn") #i think it has been running on the pca all along
```
